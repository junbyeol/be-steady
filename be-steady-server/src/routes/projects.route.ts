...
export class ProjectRoute implements Routes {
  ...
  private initializeRoutes() {
    ...
    this.router.get(`${this.path}/:id`, this.project.getProject);
    this.router.get(`${this.path}/:projectId/task`, this.task.findAllTasks);
    this.router.get(`${this.path}/:projectId/task/overview`, this.task.getTaskOverviewByProjectId);
  }
}
